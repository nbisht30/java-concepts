...
public class StockItem implements Comparable<StockItem> {
	...
	public void addStock(int quantity) { // to add stock
	...
	public void sellStock() { // to add stock
		this.reservedStock = 0;
	}

	public void reserveStock(int stockToReserve) {
		if (this.quantityStock >= (stockToReserve )) {
			this.reservedStock += stockToReserve;
			this.quantityStock -= stockToReserve;
		}
		System.out.println("quantityStock: " + this.quantityStock + " reservedStock:" + this.reservedStock);

	}

	public void releaseStock() {
		this.quantityStock += this.reservedStock;
		this.reservedStock = 0;
	}
